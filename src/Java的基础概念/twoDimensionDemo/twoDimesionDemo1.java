...
public class twoDimesionDemo1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        //System.out.println(arr3[0]);//[I@6acbcfc0  表示获取二维数组中的第一个一维数组
        //arr3[0]:二维数组中的第一个一维数组
        //arr3[0][0]:获取第一个一维数组中 0 索引的元素
        //System.out.println(arr3[0][0]);//1
        /*int i = 1;
        int j = 4;*/
        //System.out.println(arr3[1][4]);//打印数字 8

        //System.out.println(arr3[2][0]); ArrayIndexOutOfBoundsException
        /*Exception in thread "main" java.lang.ArrayIndexOutOfBoundsException: Index 2 out of bounds for length 2
	        at Java的基础概念.twoDimensionDemo.twoDimesionDemo1.main(twoDimesionDemo1.java:36)
        * */
        //3.遍历数组
        //外循环：遍历二维数组，得到每一个一维数组
        //内循环：遍历每一个一维数组，得到每一个元素
