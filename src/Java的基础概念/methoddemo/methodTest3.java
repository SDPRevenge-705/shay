...
public class methodTest3 {
    ...
    //在以后实际开发当中，我们一般是把重复的代码或者具有独立功能的代码抽取到方法中
    //1.我要干嘛？比较两个长方形的面积
    //2.我干这件事情，需要什么才能完成？ 两个长方形的面积
    //               面积1 面积2
    /*public static void compareArea(double len1,double width1,double len2,double width2){
